...
export function App() {
  ...
  const servicos = [
    ...
    { id: 2, description: 'Divórcio' },
    { id: 3, description: 'Trabalhista' },
    { id: 4, description: 'Dano Moral' },
    { id: 5, description: 'Indenização' },
    { id: 6, description: 'Consumidor' },
    { id: 7, description: 'Criminal' },
    { id: 8, description: 'Outros Assunto' },
  ];
  ...
  function enviarMensagem() {
    const texto = `Olá, meu nome é ${nome} e o meu e-mail é ${email} e estou buscando o serviço de: ${servico}
    ${mensagem}`;
    setUrlApi(`https://api.whatsapp.com/send?phone=XXXXX&text=${texto}`);
    window.open(urlApi);
  }
      ...
      <main className='App'>
        ...
        >
          ...
          <div className='md:w-2/3 w-full'>
            <h2 className='text-2xl lg:text-5xl leading-tight max-w-3xl font-semibold my-6 text-yellow-600 tracking-tight'>
              Escritório Especializado em Ação de Inventário Judicial e
              Extrajudicial
            </h2>
            <p className='mb-8 text-white text-2xl'>
              Envie uma mensagem pelo WhatsApp para esclarecer as suas dúvidas e
              agendar uma consulta presencial ou por teleconferência.
            </p>
          </div>
          ...
          <div className='flex flex-wrap gap-0 items-center justify-center md:justify-start md:gap-8'>
            ...
            <div className='text-white'>
              ...
              <p className='mb-0 md:text-left text-center'>
                Advogado Especialista em Direito de Família e Sucessões, Direito
                Criminal,
              </p>
              <p className='mb-4 md:text-left text-center'>
                Direito Previdenciário, Direito Trabalhista e Gestão Jurídica da
                Empresa.
              </p>
              <a
        ...
        <section className='bg-white p-8'>
          <h3 className='font-semibold leading-tight lg:text-4xl text-2xl text-center text-yellow-600 tracking-tight'>
            Nosso escritório conta com uma ampla experiência em Direito de
            Família,
          </h3>

          <h3 className='font-semibold leading-tight lg:text-4xl text-2xl text-center text-yellow-600 tracking-tight'>
            atuando de forma ágil e segura em todas as etapas do processo e em
            qualquer lugar do Brasil.
          </h3>

          <p className='text-center'>
            Em qualquer momento da sua vida e quando você precisar, nós podemos
            te ajudar a conquistar os seus Direitos.
          </p>
          ...
          <div className='flex flex-wrap gap-4 justify-center pt-8'>
            ...
            <div className='bg-sky-900 block p-6 rounded-lg shadow-lg max-w-sm'>
              ...
              <p className='text-white mb-4 text-center text-lg'>
                O Contrato de Honorários, procuração e demais documentos para a
                instrução do processo são enviados via email.
              </p>
            </div>
            <div className='bg-sky-900 block p-6 rounded-lg shadow-lg max-w-sm position'>
              ...
              <p className='text-white mb-4 text-center text-lg'>
                Agende um horário e fale com nosso time de advogados pelo
                WhatsApp, por vídeo ou chat, sempre que necessário.
              </p>
            </div>
            <div className='bg-sky-900 block p-6 rounded-lg shadow-lg max-w-sm'>
              <img
              ...
              <p className='text-white mb-4 text-center text-lg'>
                Protocolamos processos em todo o Brasil através do Processo
                Judicial Eletrônico de cada Tribunal.
              </p>
            </div>
            <div className='bg-sky-900 block p-6 rounded-lg shadow-lg max-w-sm'>
              <img
              ...
              <p className='text-white mb-4 text-center text-lg'>
                Nosso escritório prioriza uma comunicação acessível aos
                clientes, com linguagem simples a fim de “descomplicar o
                direito”.
              </p>
            </div>
            <div className='bg-sky-900 block p-6 rounded-lg shadow-lg max-w-sm'>
              ...
              <p className='text-white mb-4 text-center text-lg'>
                Você receberá atendimento individualizado e personalizado, tendo
                acesso ao WhatsApp do seu advogado.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className='bg-gradient-to-br from-sky-900 via-slate-800 to-black p-8'>
          ...
          <p className='font-semibold leading-tight lg:text-4xl mb-6 text-2xl text-center text-white tracking-tight'>
            O Advogado Especialista cuida das questões jurídicas do caso, mas
            também precisa ter a sensibilidade para entender os aspectos
            emocionais presentes em cada situação, auxiliando seus clientes a
            tomarem atitudes e decisões corretas e pautadas na lei, sem se
            deixarem levar sentimentos envolvidos.
          </p>
              ...
              <div className='grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12'>
                <div className='align-content-flex-start flex flex-row flex-wrap justify-between md:px-12 md:py-6 md:px-12 px-6 py-0'>
                  ...
                  <p className='text-white mb-10 md:mb-4'>
                    Adauto Campos é Advogado desde 2001, inscrito na OAB/SP sob
                    o nº 189.438, é especialista em Direito de Família e
                    Sucessões, Direito Previdenciário, Direito Trabalhista e
                    Gestão Jurídica da Empresa.
                  </p>

                  <p className='text-white mb-10 md:mb-4'>
                    É um escritório brasileiro que pratica a advocacia com visão
                    de negócios e foco em resultados.
                  </p>

                  <p className='text-white mb-10 md:mb-4'>
                    Com um time de profissionais trabalhando de forma integrada,
                    lidamos com casos rotineiros e multidisciplinares complexos
                    que exigem os talentos coordenados de profissionais
              ...
              <div className='flex flex-col justify-center'>
                ...
                <div className='mb-3'>
                  ...
                  >
                    ...
                    <option value='Outros Assunto'>Outros Assunto</option>
                  </select>
                </div>
                <div className='mb-3'>
                  <textarea
